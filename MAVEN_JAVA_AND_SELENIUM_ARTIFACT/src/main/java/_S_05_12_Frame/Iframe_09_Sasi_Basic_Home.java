...
public class Iframe_09_Sasi_Basic_Home {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement LoopButon = F.findElement(By.xpath("/html/body/div/div/form/div[2]/div[1]/div[2]/div[3]/div/div/div[2]/div/div[1]/div[1]/div[1]/span"));
		LoopButon.click();				
		WebElement YESClick = F.findElement(By.xpath("/html/body/div/div/form/div[2]/div[1]/div[2]/div[3]/div/div/div[2]/div/div[2]/div[3]/span"));
		YESClick.click();
//		Select LoopSelect = new Select(LoopButon);
//		LoopSelect.selectByIndex(1);
	WebElement NextPage = F.findElement(By.xpath("/html/body/div/div/form/div[2]/div[1]/div[3]/div[1]/div[1]/div/span/span"));
	NextPage.click();
